    ...
    <div class="form-group container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <asp:DropDownList ID="ddl_employee_id" runat="server" class="form-control" OnSelectedIndexChanged="ddl_employee_id_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList><br />
